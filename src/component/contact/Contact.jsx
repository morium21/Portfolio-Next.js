...
const Contact = () => {
  return (
    <section className="bg-[#1C1C1C] py-15 text-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Grid Layout */}
        <div className="grid md:grid-cols-2 gap-12 items-start flex">
          {/* Left Side */}
          <div>
        ...
        {/* Right side Form */}
        <form className="space-7-5">
          <div>
            <label className="block mb-1 font-medium text-slate-700">Name</label>
            <input type="text" className="w-full rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-400 focus:outline-none" 
            placeholder="Enter your name" 
            />

          </div>
          <div>
            <label className="block mb-3 font-medium text-slate-700">Email</label>
            <input type="text" className="w-full rounded-xl border border-slate-500 focus:ring-2 focus:ring-indigo-400 focus:outline-none" 
